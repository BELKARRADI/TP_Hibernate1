 ...
 * @author Lachgar
 */
@WebServlet(name = "RecupMdp", urlPatterns = {"/RecupMdp"})
public class RecupMdp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(clt.getCode()==0){
            request.setAttribute("code", "Code invalide");
            ...
            if(code==clt.getCode()){
                ...
                request.getRequestDispatcher("ModifierPass.jsp").forward(request, response);
